...
import (
	...
	helper "github.com/venkateshBS1/golang_user_management_jwt/helpers"

	"github.com/gin-gonic/gin"
	"github.com/go-playground/validator/v10"
	"github.com/venkateshBS1/golang_user_management_jwt/database"
	"github.com/venkateshBS1/golang_user_management_jwt/models"
...
func VerifyPassword(userPassword string, providedPassword string) (bool, string) {
	...
	if err != nil {
		msg = fmt.Sprintf("email or password is oncorrect")
		check = false
	}
...
func (uc *UserController) Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if count > 0 {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "this email or phone Numner already exists"})
		}
...
func (uc *UserController) Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "email or password is incarrect"})
			return
		}
		...
		if foundUser.Email == nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "USER NOT FOUNT!"})
		}
